...
import com.itlize.microservice.others.service.ProjectService;
...
public class ProjectController {
    ...
    Project getProjectById(@PathVariable int projectId){
...
//    }
//
//    @PutMapping("/project/{projectId}/add/column/{column_name}")
//    void addColuimnForProjectResource(@PathVariable("project_id") int project_id,@PathVariable("column_name") String column_name){
//
//    }
